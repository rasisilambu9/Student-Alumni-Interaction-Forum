...
$password ="";
$dbname="forum";
$query1= "INSERT INTO `stud_det` ( `regno`,`name`,`academic`,`dob`,`mail`, `phno`) VALUES ('$rollno','$name','$acyear','$dob','$mail','$phno')";
$sel="Select `regno` from `stud_det`"; 
// Create connection
