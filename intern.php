...
<form method=post action=insert_intern.php class="form1"> 
<font color=black><b>
UserName</b></font><br>
...
<input type=text name="comp" placeholder=Company></input>
 <br>
 <font color=black></b>Intership Posting<b></font><br>
<input type=text name="post" placeholder="Eg:Tester" ></input><br>
<font color=black></b>Prerequiste<b></font><br>
<input type=text name="desc" placeholder="Eg:CGPA Upto 8.0" ></input><br>
